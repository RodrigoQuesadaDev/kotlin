...
fun AndroidSyntheticFile(name: String, vararg contents: String) = AndroidSyntheticFile(name, contents.joinToString("\n\n"))
...
public abstract class SyntheticFileGenerator(protected val project: Project) {
    ...
    public companion object {
        ...
        private val TOOLS_FILE = AndroidSyntheticFile("tools",
