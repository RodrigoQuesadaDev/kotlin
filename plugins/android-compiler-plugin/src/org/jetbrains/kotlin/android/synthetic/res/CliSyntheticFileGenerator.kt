...
public open class CliSyntheticFileGenerator(
    ...
    private val scope by lazy { GlobalSearchScope.allScope(project) }

    private val psiElementFinders by lazy {
        // Filter out Kotlin light class finders
        project.getExtensions(PsiElementFinder.EP_NAME).filter { it is PsiElementFinderImpl }
    }
